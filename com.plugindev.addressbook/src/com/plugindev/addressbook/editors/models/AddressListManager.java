...
public class AddressListManager {
	...
	private List<AddressList> objects;
	...
	public File getDescriptionFile(){
		...
		return Platform.getStateLocation(Platform.getBundle(Activator.PLUGIN_ID)).
	...
	public void remove(AddressList object, boolean notify) {
