...
public class EditListsConfigWizardPage extends WizardPage {
	...
	public void setVisible(boolean visible) {
		if (visible) {
			AddressCategory category = ((NewAddressItemWizardPage)getPreviousPage()).getSelectedAddressCategory();
			String peopleName = ((NewAddressItemWizardPage)getPreviousPage()).getSelectedName();
